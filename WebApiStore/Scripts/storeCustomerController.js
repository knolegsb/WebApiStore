...
var removeFormatCart = function (productSelection) {
...
model.products.subscribe(function (newProducts) {
    ...
    customerModel.productCategories.push.apply(customerModel.productCategories, model.products().map(function (p) {
        return p.Category;
    })
...
var filterProductsByCategory = function () {
    ...
    customerModel.filteredProducts.push.apply(customerModel.filteredProducts, model.products().filter(function (p) {
